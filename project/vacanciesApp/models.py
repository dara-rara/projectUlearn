...
class Main(models.Model):
    image = models.ImageField(upload_to='images/%d.%m.%Y', blank=False, verbose_name='Изображение')
...
class Demand(models.Model):
    first_graph = models.ImageField(upload_to='images/%d.%m.%Y', blank=False,
    ...
    second_graph = models.ImageField(upload_to='images/%d.%m.%Y', blank=False,
    ...
    third_graph = models.ImageField(upload_to='images/%d.%m.%Y', blank=False,
